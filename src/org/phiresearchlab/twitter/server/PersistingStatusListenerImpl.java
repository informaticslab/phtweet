...
import org.phiresearchlab.twitter.dao.HashTagDAO;
 ...
 * Jul 28, 2011
 */
@Service("persistingStatusListenerService")
public class PersistingStatusListenerImpl implements PersistingStatusListener, StatusListener {
	
	private static final long ONE_MINUTE = 1000 * 60;
	private static final int MAX_RETRIES = 7;
	
	private static Logger LOG = Logger.getLogger(PersistingStatusListenerImpl.class);
